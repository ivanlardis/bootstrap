...
!function (a, b, c, d) {
    ...
    var f = "vide", g = {
        ...
        position: "50% 50%",
        posterType: "detect"
    }, h = /iPad|iPhone|iPod/i.test(d.userAgent), i = /Android/i.test(d.userAgent);
    a[f] = {lookup: []};
    var j = function (a) {
        var b, c, d = {};
    ...
    e.prototype.init = function () {
        ...
        }), "detect" === this.settings.posterType ? l(this.path, function (a) {
            b.wrapper.css("background-image", "url(" + a + ")")
        }) : this.wrapper.css("background-image", "url(" + this.path + "." + this.settings.posterType + ")"), "static" === this.element.css("position") && this.element.css("position", "relative"), this.element.prepend(this.wrapper), h || i || (this.video = a("<video><source src='" + this.path + ".mp4' type='video/mp4'><source src='" + this.path + ".webm' type='video/webm'><source src='" + this.path + ".ogv' type='video/ogg'></video>"), this.video.css("visibility", "hidden"), this.video.prop({
